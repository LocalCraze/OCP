# Fall 2026 Season Plan (Proposal)

Working plan to pitch to the coaches. Landing page: `fall-2026/landing-page.html`
(published as a shareable artifact — see session notes).

## Concept: One Team, Two Rosters

- **Navy roster** and **Gray roster**, ~11 players each (22 rostered total).
...
- **Down payment** to start the season — amount TBD (Eric to break down).
- Monthly payments due **Sept 1, Oct 1, Nov 1**.

### Tournament fees (separate, pay-per-event)

- Expect **~2 tournaments/month per roster**.
- Player fee **$60–$90 per tournament**, charged only to players in that event.
- Typical all-in per player: $225 + (2 × $60–90) ≈ **$345–$405/month**.
...
- [ ] Confirm whether coach kids pay tournament fees (assumed yes for now)
